...
loja_praia.apresentar_endereco()  # valor 1

print(loja_praia.vender())  # valor 1
print(loja_centro.vender())  # valor 1

loja_centro.alterar_tarifa(1.50)

print(loja_praia.vender())  # valor 2
print(loja_centro.vender())  # valor 2
